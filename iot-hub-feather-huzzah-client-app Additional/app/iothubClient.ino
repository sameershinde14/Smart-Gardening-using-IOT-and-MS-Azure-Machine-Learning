...
{
    Serial.printf("Sucessfully in sendMessage.\r\n");
    ...
    else
    {
        ...
        //Serial.printf("before destroy message:\r\n");
        IoTHubMessage_Destroy(messageHandle);
        //Serial.printf("after destroy message:\r\n");
    }
}
...
{
    //Serial.printf("Sucessfully in receiveMessageCallback.\r\n");
...
void twinCallback(
    ...
    void *userContextCallback)
{
    //Serial.printf("Sucessfully in twincallback");
    char *temp = (char *)malloc(size + 1);
    ...
    temp[size] = '\0';
    //Serial.printf("Sucessfully in twinmessage");
    parseTwinMessage(temp);
    //Serial.printf("Sucessfully after parsing twinmesssage");
    free(temp);
}
