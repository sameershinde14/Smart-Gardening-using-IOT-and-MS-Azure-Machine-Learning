...
void loop()
{
    if (!messagePending && messageSending)
    {
        ...
        //Serial.printf("Sucessfully in reading Message.\r\n");
        sendMessage(iotHubClientHandle, messagePayload, temperatureAlert);
        //Serial.printf("Sucessfully in sending message.\r\n");
        messageCount++;
        delay(interval);
    }
    //Serial.printf("Sucessfully in dowork.\r\n");
    delay(7000);
    IoTHubClient_LL_DoWork(iotHubClientHandle);
    //Serial.printf("Sucessfully in doing work.\r\n");
    delay(6000);
}
